  ...
  const content = (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-extrabold text-[12px] text-gray-400 uppercase tracking-widest">
          Knowledge Base
        </h2>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-bold text-gray-500 bg-white/[0.02] px-2 py-0.5 rounded border border-white/[0.04]">
            {documents.length}
          </span>
        </div>
      </div>
          ...
          className={`
            ...
            ${
              isDragging
                ...
                : "border-white/[0.07] hover:border-indigo-500/40 hover:bg-white/[0.015]"
            }
          `}
        ...
        >
          ...
          >
            <svg
              ...
              stroke="currentColor"
              strokeWidth="2.2"
              className={`transition-colors ${isDragging ? "text-indigo-400" : "text-gray-500 group-hover:text-indigo-400"}`}
            >
              {isDragging ? (
      ...
      <div className="mt-4 flex-1 overflow-y-auto space-y-2 pr-0.5">
        {documents.length === 0 && (
          <div className="flex flex-col items-center justify-center h-32 gap-2 opacity-40">
            ...
            <p className="text-[11px] text-gray-500">No documents yet</p>
          </div>
        )}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col overflow-hidden flex-1 min-w-0">
                <span className="text-[12px] font-semibold text-gray-300 truncate">
                  {doc.name}
                </span>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[999] flex items-center justify-center p-4">
          <div className="w-full max-w-lg bg-[#0c0c0e] border border-white/10 rounded-2xl p-6 shadow-2xl animate-in zoom-in-95 duration-200 max-h-[80vh] flex flex-col">
            ...
            <div className="mt-4 flex justify-end">
              <button
                onClick={() => setSummaryData(null)}
                className="px-4 py-1.5 rounded-lg bg-white/[0.05] border border-white/10 text-[11px] font-bold text-gray-400 hover:text-white transition-colors cursor-pointer"
              >
                Close
              </button>
            </div>
