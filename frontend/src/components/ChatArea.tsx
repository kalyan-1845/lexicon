      ...
      <div className="p-4 border-t border-white/5 bg-[#0a0a0b]/80 backdrop-blur-md">
        <div className="max-w-4xl mx-auto relative flex items-center">
          <input 
            ...
            className="w-full bg-gray-900/50 border border-white/10 rounded-xl px-4 py-4 pr-12 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
          />
          <button className="absolute right-2 p-2 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white transition-colors">
