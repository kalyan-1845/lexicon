    ...
    <>
      <aside className="w-64 border-r border-white/[0.04] bg-[#09090b] flex flex-col h-full shrink-0">
        ...
        <div className="flex-1 overflow-y-auto px-2 space-y-6">
          <div>
            <button className="w-full flex items-center justify-between px-3 py-2 rounded-lg text-xs font-semibold text-gray-400 hover:text-white hover:bg-white/[0.03] transition-all group">
